...
public class ServerRequest
{
    ...
    public class FetchUserDataAsyncTack extends AsyncTask<Void,Void,User>
    {
        ...
        protected User doInBackground(Void... params)
        {
            ...
            param.add(new BasicNameValuePair("password",user.password));
            try {
                URL url = new URL("http://jesusveraalba.es/santaseas/login.php");
                HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
                urlConnection.setReadTimeout(15000);
                urlConnection.setConnectTimeout(15000);
                ...
                user=new User(name,saldo,username,password);
            }catch (Exception e)
            {
                e.printStackTrace();
            }
